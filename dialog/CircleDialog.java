...
public class CircleDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView valueRadius = (TextView) findViewById(R.id.circle_value_radius);
        TextView valueMidPoint = (TextView) findViewById(R.id.circle_value_midPoint);
        ...
        src_valueRadius = CircleDrawingView.getRadius();
        src_valueMidPoint = CircleDrawingView.getCircleMidPoint();
        ...
        valueRadius.setText(src_valueRadius+" px(s)");
